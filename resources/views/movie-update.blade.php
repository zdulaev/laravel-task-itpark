...
<div class="album py-5 bg-light">
    <div class="container">
        ...
        <form class="row g-3 needs-validation" method="post" action="{{ route('movie-store', $data->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="col-12">
            ...
            <div class="col-12">
                <a href="{{ route('movie', $data->id) }}" class="btn btn-light">Go back</a>
